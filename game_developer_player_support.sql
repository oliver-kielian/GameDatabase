...
--
-- Table structure for table `player_support`
--
...
--
-- Dumping data for table `player_support`
--

LOCK TABLES `player_support` WRITE;
/*!40000 ALTER TABLE `player_support` DISABLE KEYS */;
INSERT INTO `player_support` VALUES (3,1,100),(4,8,101),(4,9,102);
/*!40000 ALTER TABLE `player_support` ENABLE KEYS */;
UNLOCK TABLES;
